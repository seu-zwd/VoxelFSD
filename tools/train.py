...
def parse_config():
    ...
    parser.add_argument('--extra_tag', type=str, default='3.30', help='extra tag for this experiment')
    ...
    parser.add_argument('--logger_iter_interval', type=int, default=1000, help='')
    ...
    cfg.EXP_GROUP_PATH = args.cfg_file.split('/')[-2]  # remove 'cfgs' and 'xxxx.yaml'
